...
export const pl: Translations = {
  ...
  compare: {
    ...
    noMatchesBody: 'Żadne ukończone orzeczenie nie pasuje do tego filtra w żadnej jurysdykcji. Poluzuj warunek.',
    ...
    savePairTooLarge: 'Jedna ze stron przekracza 5000 orzeczeń. Najpierw zawęź filtr.',
    saved: 'Para zapisana',
    ...
    extractOnBoth: 'Ekstrahuj na kolekcji {{jurisdiction}}',
