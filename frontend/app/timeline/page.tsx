...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  appeal: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400',
  enforcement: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400',
  procedural: 'bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400',
  legislative: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400',
      ...
      <div className="space-y-3">
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-4 pr-12 rounded-[16px] bg-[rgba(255,255,255,0.9)] dark:bg-[rgba(30,41,59,0.6)] border border-border/50 text-foreground placeholder:text-muted-foreground text-sm leading-relaxed resize-y focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 transition-all"
          />
          <button
