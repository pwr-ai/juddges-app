          ...
          <div ref={scrollAreaRef} className="flex-1">
                ...
                <div className="space-y-2">
                  ...
                  {suggestedPrompts.map((prompt, index) => (
                    <button
                      ...
                      className="block w-full text-left px-4 py-3 rounded-2xl bg-gradient-to-br from-slate-50/80 via-white to-slate-50/60 dark:from-slate-900/80 dark:via-slate-900 dark:to-slate-900/60 border border-slate-200/60 dark:border-slate-800/60 hover:border-primary/40 dark:hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-0.5 transition-all duration-300 text-sm text-slate-800 dark:text-slate-200"
                    >
                      {prompt}
                    </button>
                  ))}
            ...
            {isGenerating && (
              <div className="mb-4 flex gap-3 justify-start">
                ...
                <div className="rounded-2xl bg-gradient-to-br from-white via-slate-50/50 to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 border border-slate-200/60 dark:border-slate-800/60 shadow-sm px-5 py-4">
