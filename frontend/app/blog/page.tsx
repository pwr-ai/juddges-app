...
const mockPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Reading Appellate Judgments: A Practical Research Guide",
    excerpt:
      "A practical guide to reading appellate judgments, identifying holdings, and extracting reusable legal reasoning.",
    author: {
      name: "Anna Kowalska",
    ...
    tags: ["Judgments", "Legal Research", "Poland"],
    category: "Tutorials",
    read_time: 12,
    views: 2341,
    likes: 156,
