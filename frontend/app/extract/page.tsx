...
const documentTypeBadgeStyles: Record<string, string> = {
  judgment: "bg-blue-400/8 text-blue-800 dark:text-blue-200 border border-blue-400/15 dark:border-blue-500/15 shadow-sm shadow-blue-400/5",
  tax_interpretation: "bg-purple-400/8 text-purple-800 dark:text-purple-200 border border-purple-400/15 dark:border-purple-500/15 shadow-sm shadow-purple-400/5",
  default: "bg-slate-200/40 dark:bg-slate-800/40 text-slate-700 dark:text-slate-200 border border-slate-200/30 dark:border-slate-800/30",
};
...
function ExtractPageContent() {
  ...
  return (
    <PageContainer fillViewport className="flex flex-col">
      ...
      <div className="my-8 border-t border-slate-200/30 dark:border-slate-800/30" />
