...
export const en: Translations = {
  ...
  compare: {
    ...
    filterKeysIgnored: 'Some filter keys were ignored:',
    savePair: 'Save as collection pair',
    savePairTitle: 'Save both result sets',
    savePairName: 'Name',
    savePairHint: 'Creates "{{name}} — PL" and "{{name}} — UK".',
    savePairTooLarge: 'One side exceeds the per-collection limit. Narrow the filter first.',
    savePairSaving: 'Saving…',
    savePairGenericError: 'Could not save the pair.',
    baseSchemaEyebrow: 'Base schema',
    extendedSchemaEyebrow: 'Extended schema',
    saved: 'Pair saved',
    ...
    pairSchemaEmpty: 'This schema has no fields the comparison can chart.',
    pairExtensionNoJobPl: 'The UK collection has an extraction job, but the PL collection does not yet.',
    pairExtensionNoJobUk: 'The PL collection has an extraction job, but the UK collection does not yet.',
    pairExtensionSchemaMismatch: 'The two collections were extracted with different schemas — run the same one on both to compare.',
    pairExtensionSchemaNotFound: 'The extraction schema used for this pair no longer exists.',
    pairExtensionFailed: 'The extended-schema comparison could not be loaded. Base fields above are unaffected.',
    pairNotFound: 'This pair could not be found. It may have been deleted, or you may not have access to it.',
