...
function SanitizedHtmlView({
  ...
  return (
    <div className="rounded-2xl border border-slate-200/50 dark:border-slate-800/50 bg-white/60 dark:bg-slate-900/40 backdrop-blur-md">
      <style>{`
        ...
        html.dark .document-content [style*="color"] {
          color: rgb(241 245 249) !important;
        }
        /* Make borders visible in dark mode */
        html.dark .document-content * {
          border-color: rgba(255, 255, 255, 0.2) !important;
        }
        html.dark .document-content .doc-section {
          border-bottom-color: rgba(255, 255, 255, 0.2) !important;
        }
        html.dark .document-content h1 {
          border-bottom-color: rgba(255, 255, 255, 0.4) !important;
          color: rgb(255, 255, 255) !important;
          font-weight: 800 !important;
        }
        html.dark .document-content h2 {
          color: rgb(255, 255, 255) !important;
          font-weight: 700 !important;
          border-top: none !important;
        }
        html.dark .document-content h3 {
          color: rgb(255, 255, 255) !important;
          font-weight: 700 !important;
        }
        html.dark .document-content h4,
        html.dark .document-content h5,
        html.dark .document-content h6 {
          color: rgb(255, 255, 255) !important;
          font-weight: 700 !important;
        }
        html.dark .document-content table,
        html.dark .document-content th,
        html.dark .document-content td {
          border-color: rgba(255, 255, 255, 0.2) !important;
        }
        html.dark .document-content blockquote {
        ...
        html.dark .document-content ul,
        html.dark .document-content ol {
          color: rgb(241 245 249) !important;
        }
        html.dark .document-content li {
          color: rgb(241 245 249) !important;
        }
      ...
      `}</style>
      <div
        className="document-content w-full px-6 pt-6 pb-4 prose prose-slate dark:prose-invert max-w-none text-slate-900 dark:text-slate-100"
        role="document"
        ...
        <PageContainer width="xl" fillViewport className="py-4">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0">
              {/* Offline mode banner */}
              {isOfflineMode && (
                <div className="mb-4 flex items-center gap-2 rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20 px-4 py-2.5 text-sm text-amber-800 dark:text-amber-200">
                  ...
                  >
                    <div className="flex flex-col gap-4 p-1">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        {documentType && (
                          <Badge variant="secondary" className="text-xs font-medium bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700">
                            {documentType}
                          </Badge>
                        )}
                        {dateStr && (
            ...
            <BaseCard
              ...
              title={
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="secondary" className="text-xs flex items-center gap-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-800 whitespace-normal break-words">
                  ...
                  title={
                    <div className="flex items-center justify-between w-full">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant="secondary" className="text-xs flex items-center gap-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800">
                          <Sparkles className="h-3 w-3" />
                          GPT-4
                        </Badge>
                      </div>
                  ...
                  title={
                    <div className="flex items-center justify-between w-full">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant="secondary" className="text-xs flex items-center gap-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800">
                          <Sparkles className="h-3 w-3" />
                          AI Analysis
                        </Badge>
                      </div>
                            ...
                            <ul className="space-y-3">
                              {keyPointsResult.arguments.map((arg, idx) => (
                                <li key={idx} className="flex items-start gap-3 text-sm">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <span className="font-medium text-blue-700 dark:text-blue-300">{arg.party}:</span>
                                    <span className="text-foreground ml-1">{arg.text}</span>
                                    <span className="ml-2 text-xs text-muted-foreground bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">
                                      {arg.source_ref}
                                    </span>
                                  </div>
                                </li>
                                ...
                                <li key={idx} className="flex items-start gap-3 text-sm">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    {principle.legal_basis && (
                                      <span className="ml-2 text-xs font-medium text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-900/30 px-1.5 py-0.5 rounded">
                                        {principle.legal_basis}
                                      </span>
                                    )}
                                    <span className="ml-2 text-xs text-muted-foreground bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">
