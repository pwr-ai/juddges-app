  ...
  return (
    <>
      <div className="h-full flex flex-col min-h-0">
        ...
        <div className="flex-shrink-0 px-4 py-3 border-b border-white/20 dark:border-slate-700/20 flex items-center justify-between gap-2">
          ...
          <div>
            {fields.length === 0 ? (
              ...
              <div className="flex items-center justify-center min-h-full p-6">
                ...
                "dark:shadow-[0_18px_45px_0_rgba(0,0,0,0.6),0_8px_20px_0_rgba(139,92,246,0.25),inset_0_1px_0_0_rgba(255,255,255,0.15)]",
                "overflow-hidden"
              )}>
                {/* Minimal glass layer without heavy gradients */}
                <div className="absolute inset-0 pointer-events-none rounded-2xl bg-white/30 dark:bg-slate-900/30 -z-10" />
                
                {/* Content */}
                <div className="relative z-10 flex flex-col items-center text-center">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary/15 dark:bg-primary/25 mb-4 backdrop-blur-md border border-primary/30 dark:border-primary/40">
                    <Inbox className="h-10 w-10 text-primary dark:text-primary/90" />
                  </div>
              ...
              <div className="p-6">
                ...
                {selectedFields.size > 0 && (
                  <div className="sticky top-0 z-10 -mx-6 -mt-6 px-6 py-2 flex items-center gap-2 bg-background/95 backdrop-blur-sm border-b border-white/10 dark:border-slate-700/10 mb-3">
                ...
                <div className={cn(
                  "relative rounded-xl p-4",
                    ...
                    "dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.3),0_4px_16px_0_rgba(139,92,246,0.15),inset_0_1px_0_0_rgba(255,255,255,0.08)]",
                  "overflow-hidden"
                )}>
                  {/* Minimal glass layer without heavy gradients */}
                  <div className="absolute inset-0 pointer-events-none rounded-xl bg-white/20 dark:bg-slate-900/20 -z-10" />
