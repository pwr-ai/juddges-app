...
class TestExtractionExport:
    ...
    @pytest.mark.anyio
    async def test_export_extraction_csv(
        self,
        client: AsyncClient,
        auth_headers: dict
    ):
    ...
    async def test_export_nonexistent_extraction(
        ...
        response = await client.get(
            "/api/extractions/nonexistent-job-999/export",
            headers=auth_headers
        )
    ...
    async def test_export_without_auth(
        self,
        client: AsyncClient,
        mock_extraction_id: str
    ):
        """Test export fails without auth."""
        response = await client.get(
            f"/api/extractions/{mock_extraction_id}/export"
        )
...
class TestExtractedDataFiltering:
    ...
    @pytest.mark.anyio
    async def test_filter_by_text_field(
        self,
        client: AsyncClient,
        auth_headers: dict
    ):
    ...
    async def test_filter_empty_results(
        ...
        filter_data = {
            "filters": {
                "impossible_field": "nonexistent_value"
            }
        }
...
class TestFacetCounts:
    ...
    @pytest.mark.anyio
    async def test_get_facet_counts(
        self,
        client: AsyncClient,
        auth_headers: dict
    ):
    ...
    @pytest.mark.anyio
    async def test_facet_counts_without_auth(
        self,
        client: AsyncClient
    ):
...
class TestFilterOptions:
    ...
    @pytest.mark.anyio
    async def test_filter_options_without_auth(
        self,
        client: AsyncClient
    ):
