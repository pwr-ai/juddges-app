...
export const enterpriseContent = {
  ...
  caseStudies: [
    {
      ...
      solution:
        "Deployed AI-Tax with custom extraction schemas to automatically parse court judgments, extract key fields (loan terms, court decisions, legal reasoning), and visualize document similarity.",
      results: [
        {
          metric: "80%",
          value: "Time Saved",
    ...
    },
    {
      ...
      solution:
        "Implemented AI-Tax with automated document ingestion, multi-language processing, and custom alerts for regulatory changes.",
      results: [
        {
          metric: "95%",
          value: "Coverage",
    ...
    },
    {
      ...
      solution:
        "Deployed cloud-hosted AI-Tax with semantic search, citation extraction, and similarity clustering specialized for UK legal documents.",
      results: [
        {
          metric: "50K+",
  ...
  faqs: [
    {
      question: "What languages does AI-Tax support?",
      answer:
        "AI-Tax currently supports Polish, English, German, and French for document processing and search. We can add support for additional languages based on your requirements.",
      category: "Features",
    },
    {
    ...
    {
      question: "Can we deploy AI-Tax on our own infrastructure?",
      answer:
    ...
    {
      question:
        "What makes AI-Tax different from other legal AI tools?",
      answer:
        "AI-Tax is built on proven academic research and has processed over 3 million legal documents in production. Unlike consumer tools, we offer on-premise deployment, custom development, domain-specific AI models, and enterprise-grade security. Our platform is designed for legal professionals who need reliability, accuracy, and control.",
      category: "Product",
    },
    {
      question: "Can we integrate AI-Tax with our existing document management system?",
      answer:
        "Yes, AI-Tax provides a REST API and supports integration with major document management systems like iManage, NetDocuments, and SharePoint. We can also develop custom integrations for proprietary systems.",
      category: "Integration",
    },
    {
      question: "What kind of documents can AI-Tax process?",
      answer:
        "AI-Tax can process various legal document types including court judgments, legal opinions, contracts, regulations, tax interpretations, and more. We support PDF, DOCX, HTML, and plain text formats. Custom document type support can be added as needed.",
      category: "Features",
    },
  ],
  ...
  team: {
    university: {
      ...
      description:
        "AI-Tax is developed by researchers at one of Poland's leading technical universities, with expertise in natural language processing, machine learning, and legal technology.",
    },
    expertise: [
