        ...
        <div className="flex flex-col gap-4 h-full">
          ...
          >
            ...
            >
              ...
              >
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary/10 via-indigo-400/10 to-purple-400/10 dark:from-primary/15 dark:via-indigo-500/15 dark:to-purple-500/15" />
              </motion.div>
              <motion.div
              ...
              >
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-white/20 via-transparent to-transparent dark:from-white/10 dark:via-transparent dark:to-transparent" />
              </motion.div>
        ...
        <div className="flex flex-col gap-4 h-full">
          <motion.div
            ...
            >
              ...
              >
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary/5 via-indigo-400/5 to-purple-400/5 dark:from-primary/10 dark:via-indigo-500/10 dark:to-purple-500/10" />
              </motion.div>
              <motion.div
                className="absolute inset-[1px] rounded-2xl pointer-events-none -z-10"
                initial={{ opacity: 0 }}
              ...
              >
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-white/10 via-transparent to-transparent dark:from-white/5 dark:via-transparent dark:to-transparent" />
              </motion.div>
