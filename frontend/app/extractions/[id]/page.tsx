...
function JobDetailsContent() {
  ...
  return (
    <PageContainer fillViewport={true}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 -m-3.5 p-6">
            ...
            <div className="space-y-1">
              ...
              <Badge
                ...
                className={cn(
                  "font-medium w-fit",
                  (jobData.status?.toLowerCase() === 'completed' || jobData.status?.toLowerCase() === 'success') && "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-green-200 dark:border-green-800",
                  jobData.status?.toLowerCase() === 'processing' && "bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 border-blue-200 dark:border-blue-800"
                )}
              >
        ...
        <div className="flex items-center justify-between mb-6 print:hidden">
          ...
          <div className="flex items-center gap-2">
            <Tabs value={resultsView} onValueChange={(v) => setResultsView(v as 'document' | 'table')}>
              <TabsList className="bg-slate-100/60 dark:bg-slate-800/60 border border-slate-200/50 dark:border-slate-700/50 h-9">
                <TabsTrigger
                  value="table"
                  className="flex items-center gap-2 px-3 data-[state=active]:bg-white/80 dark:data-[state=active]:bg-slate-700/80 data-[state=active]:shadow-sm"
                >
      ...
      {failedCount > 0 && (
        <div className="mb-6">
          <BaseCard variant="light" className="border-red-200 dark:border-red-800">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="space-y-2">
                  {failedResults.map((result) => (
                    ...
                    >
                      <div className="font-mono text-xs text-red-900 dark:text-red-200 mb-1">
                        {result.document_id}
                      </div>
                      {result.error_message && (
                        <div className="text-xs text-red-800 dark:text-red-300 whitespace-pre-wrap break-words">
                          {result.error_message}
                        </div>
                      )}
                    </div>
        ...
        return (
          ...
          <BaseCard variant="light" className="p-0">
            <div className="space-y-6 -m-3.5 p-6">
              ...
              <div className="flex items-center justify-between gap-4 px-6 pt-6 pb-4 border-b border-slate-200/50 dark:border-slate-700/50">
                <Tabs
                  value={viewMode}
                  onValueChange={(value) => setViewMode(value as "formatted" | "json")}
                  className="flex-1"
                >
                  <TabsList className="bg-slate-100/60 dark:bg-slate-800/60 border border-slate-200/50 dark:border-slate-700/50 h-10">
                    <TabsTrigger
                      value="formatted"
                      className="flex items-center gap-2 px-4 data-[state=active]:bg-white/80 dark:data-[state=active]:bg-slate-700/80 data-[state=active]:shadow-sm data-[state=active]:text-foreground"
                    >
              ...
              >
                ...
                <TabsContent value="json" className="mt-0 px-6 pb-6">
                  <div className="overflow-auto max-h-[80vh] rounded-lg border border-slate-200/50 dark:border-slate-700/50">
                    <pre className="text-sm whitespace-pre-wrap font-mono bg-slate-50/60 dark:bg-slate-900/60 p-6 rounded-lg">
