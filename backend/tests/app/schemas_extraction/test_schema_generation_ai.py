...
class TestSchemaGenerationStart:
    ...
    async def test_start_generation_with_description(
        ...
        response = await client.post(
            "/api/schemas/generate", json=request_data, headers=auth_headers
        )
    ...
    async def test_start_generation_minimal(
        ...
        request_data = {"description": "Extract basic information"}
    ...
    @pytest.mark.anyio
    async def test_start_generation_without_auth(self, client: AsyncClient):
        """Test generation fails without authentication."""
        request_data = {"description": "Test schema"}

        response = await client.post("/api/schemas/generate", json=request_data)
...
class TestSchemaRefinement:
    ...
    @pytest.mark.anyio
    async def test_refine_schema(self, client: AsyncClient, auth_headers: dict):
        ...
        # Refine it
        refine_data = {"refinement": "Also extract contract dates and amounts"}
    ...
    @pytest.mark.anyio
    async def test_refine_add_fields(self, client: AsyncClient, auth_headers: dict):
    ...
    @pytest.mark.anyio
    async def test_multiple_refinements(self, client: AsyncClient, auth_headers: dict):
...
class TestGetGenerationSession:
    ...
    async def test_get_nonexistent_session(
        ...
        response = await client.get(
            "/api/schemas/generate/nonexistent-session-999", headers=auth_headers
        )
    ...
    async def test_get_session_without_auth(
        self, client: AsyncClient, mock_session_id: str
    ):
        """Test getting session fails without auth."""
        response = await client.get(f"/api/schemas/generate/{mock_session_id}")
...
class TestCancelGeneration:
    ...
    @pytest.mark.anyio
    async def test_cancel_session(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_cancel_session_without_auth(
        ...
        response = await client.delete(f"/api/schemas/generate/{mock_session_id}")
...
class TestSimpleGeneration:
    ...
    @pytest.mark.anyio
    async def test_simple_generation(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.post(
            "/api/schema-generator/simple", json=request_data, headers=auth_headers
        )
...
class TestChatGeneration:
    ...
    async def test_chat_generation_initial(
        ...
        response = await client.post(
            "/api/schema-generator/chat", json=request_data, headers=auth_headers
        )
...
class TestSchemaTest:
    ...
    async def test_test_generated_schema(
        ...
        response = await client.post(
            "/api/schema-generator/test", json=request_data, headers=auth_headers
        )
    ...
    async def test_test_schema_with_document_id(
        ...
        request_data = {"schema": sample_schema_data, "document_id": "test-doc-123"}
