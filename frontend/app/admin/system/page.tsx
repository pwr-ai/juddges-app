  ...
  return (
    <div className="rounded-none border border-rule bg-parchment overflow-hidden animate-pulse">
      <div className="flex items-center gap-3 px-6 py-5 border-b border-rule">
        <div className="rounded-none bg-parchment-deep size-9" />
        <div className="flex-1">
          <div className="h-5 w-32 rounded-none bg-parchment-deep mb-1" />
          <div className="h-3 w-24 rounded-none bg-parchment-deep" />
        </div>
        <div className="h-6 w-20 rounded-none bg-parchment-deep" />
      </div>
      <div className="px-6 py-2">
        {Array.from({ length: 2 }).map((_, i) => (
          <div
            key={i}
            className="flex justify-between py-3 border-b border-rule last:border-0"
          >
            <div className="h-4 w-24 rounded-none bg-parchment-deep" />
            <div className="h-4 w-20 rounded-none bg-parchment-deep" />
          </div>
        ))}
      </div>
    </div>
...
export default function AdminSystemPage() {
  ...
  return (
    <div className="min-h-screen bg-background px-8 py-10">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Page heading */}
        <div className="mb-8">
          <h1 className="font-serif text-3xl font-normal text-foreground tracking-tight">System</h1>
 ...
 <div
 key={key}
 className="rounded-none border border-rule bg-parchment overflow-hidden"
 >
 <div className="flex items-center gap-3 px-6 py-5 border-b border-rule">
