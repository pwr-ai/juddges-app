...
export default function CollectionsPage() {
 ...
 className="border-slate-200/50 focus:border-primary/30 focus:ring-2 focus:ring-primary/20 hover:border-primary/20 bg-white/80 backdrop-blur-md shadow-lg hover:shadow-xl rounded-xl transition-all duration-300"
 />
 </div>
 <div className="space-y-2">
