...
\begin{document}
\title{Unite! Researcher Sercher with research for collaboration interdisciplinary}
...
Badanie:
\begin{enumerate}
    \item porównanie co umożliwia zrobienie Unitem w porównaniu do Scopus, Scival, Scholar, Semantic Scholar, Open Alex, Research Gate,
    \item przykładowe zapytania:
    \begin{enumerate}
        \item graph machine learning in quantum chemistry
    \end{enumerate}
\end{enumerate}
