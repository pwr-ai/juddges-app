    ...
    <div className={cn(
      ...
      <div className="relative mb-6 md:mb-8">
        ...
        <div className={cn(
          ...
          "dark:from-black/70 dark:via-blue-950/20 dark:to-indigo-950/15",
          "backdrop-blur-xl",
        ...
        <div className={cn(
          ...
          "dark:bg-gradient-to-br dark:from-slate-900/70 dark:via-slate-900/60 dark:to-slate-800/50",
          ...
          <div className="flex items-center flex-wrap gap-3 pt-3 pb-4 border-t border-slate-200/20 dark:border-slate-800/20">
      ...
      <div className="mb-6 md:mb-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className="group relative overflow-hidden rounded-xl py-3 flex flex-col h-full bg-gradient-to-br from-muted/30 to-muted/15 dark:from-muted/20 dark:to-muted/10 border border-border min-h-[200px]"
            >
