...
export default function OCRProcessingPage(): React.JSX.Element {
 ...
 <Badge
 variant="secondary"
 className="text-xs font-medium bg-amber-100 text-amber-700 border-amber-200"
 >
 ...
 className="rounded-lg border border-slate-200/50 p-4 bg-white/50"
 >
 ...
 rows={14}
 className="w-full rounded-lg border border-border bg-slate-50 px-3 py-2.5 text-sm text-foreground font-mono leading-relaxed resize-y focus:outline-none"
