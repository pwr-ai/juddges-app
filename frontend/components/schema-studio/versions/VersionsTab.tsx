...
const CHANGE_TYPE_COLORS: Record<SchemaChangeType, string> = {
  ...
  ai_update: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400",
  visual_edit: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400",
  code_edit: "bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400",
