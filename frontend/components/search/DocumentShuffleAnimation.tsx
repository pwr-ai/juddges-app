    ...
    <div className="relative w-32 h-40 mx-auto">
      ...
      <div
        className={cn(
          ...
          "backdrop-blur-sm border border-primary/20 dark:border-primary/30",
      ...
      <div
        className={cn(
          ...
          "dark:from-slate-900 dark:via-blue-950/30 dark:to-indigo-950/20",
          "backdrop-blur-md border-2 border-primary/30 dark:border-primary/40",
          "animate-shuffle-front",
          "motion-reduce:animate-none"
        )}
      >
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-indigo-500/5 to-purple-500/5 dark:from-primary/10 dark:via-indigo-500/10 dark:to-purple-500/10" />
...
function DocumentLines({ className = '' }: { className?: string }) {
  return (
    <div className={cn("absolute bottom-4 left-4 right-4 space-y-1.5", className)}>
      <div className="h-1 bg-gradient-to-r from-slate-300 to-slate-400 dark:from-slate-600 dark:to-slate-500 rounded-full" />
      <div className="h-1 bg-gradient-to-r from-slate-300 to-slate-400 dark:from-slate-600 dark:to-slate-500 rounded-full w-5/6" />
      <div className="h-1 bg-gradient-to-r from-slate-300 to-slate-400 dark:from-slate-600 dark:to-slate-500 rounded-full w-4/6" />
    </div>
  );
}
  ...
  return (
    <div
      className={cn(
        ...
        "border-2 border-primary/40 dark:border-primary/50",
        "animate-pulse-ring"
      )}
