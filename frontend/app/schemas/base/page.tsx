    ...
    <PageContainer fillViewport width="wide">
      ...
      >
        <div className="space-y-5">
          ...
          <div className="flex flex-wrap items-center gap-2 rounded-lg border border-slate-200/50 dark:border-slate-700/50 p-3">
            ...
            <button
              ...
              className={cn(
                ...
                activeLocale === 'en'
                  ...
                  : 'border-slate-300 dark:border-slate-700 hover:bg-muted'
              )}
            >
              English
            </button>
          ...
          <Tabs defaultValue="table" className="w-full">
            ...
            <TabsContent value="json" className="mt-4">
              <ScrollArea className="h-[540px] w-full rounded-md border bg-slate-50/50 dark:bg-slate-900/50 border-slate-200/50 dark:border-slate-700/50">
