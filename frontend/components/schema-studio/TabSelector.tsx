        ...
        {tabs.map((tab) => (
          <TabsTrigger
            ...
            className={cn(
              "flex-1",
              "relative",
              "data-[state=active]:bg-white/90 dark:data-[state=active]:bg-slate-800/90",
              "data-[state=active]:backdrop-blur-md",
              "data-[state=active]:shadow-lg",
              "data-[state=active]:shadow-primary/10",
              "data-[state=active]:text-foreground",
              "data-[state=active]:ring-1 data-[state=active]:ring-white/30 dark:data-[state=active]:ring-white/10",
              "data-[state=inactive]:bg-transparent",
              "data-[state=inactive]:text-muted-foreground",
              "data-[state=inactive]:hover:text-foreground",
              "data-[state=inactive]:hover:bg-white/20 dark:data-[state=inactive]:hover:bg-slate-800/20",
              "rounded-lg",
              "px-4 py-2",
              "font-medium",
