    ...
    <PageContainer fillViewport>
      ...
      >
        <div className="space-y-4">
          ...
          {/* Metadata */}
          <div className="rounded-lg border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm bg-gradient-to-br from-white/40 via-white/30 to-white/20 dark:from-slate-900/40 dark:via-slate-900/30 dark:to-slate-900/20 p-4 space-y-4">
          ...
          <div className="pt-4 border-t border-slate-200/50 dark:border-slate-700/50">
            ...
            <Tabs defaultValue="table" className="w-full">
              ...
              <TabsContent value="json" className="mt-4">
                <ScrollArea className="h-[400px] max-h-[50vh] w-full border rounded-md bg-slate-50/50 dark:bg-slate-900/50 border-slate-200/50 dark:border-slate-700/50">
