...
function TrendBadge({ trend }: { trend: string }) {
  const variants: Record<string, { label: string; className: string }> = {
    emerging: { label: 'Emerging', className: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' },
    declining: { label: 'Declining', className: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' },
    stable: { label: 'Stable', className: 'bg-gray-100 text-gray-700 dark:bg-gray-800/50 dark:text-gray-400' },
  };
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${
                      filterTrend === 'stable'
                        ...
                        : 'bg-gray-100 text-gray-700 dark:bg-gray-800/50 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-800/70'
                    }`}
                  >
