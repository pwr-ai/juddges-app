...
"text-sm text-foreground/80 leading-relaxed",
 ...
 <Badge key={index} variant="secondary"className="text-xs bg-white/50 border-slate-200/50 text-foreground/70">
 {tag}
 </Badge>
 ))}
 </div>
 ...
 className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-md bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors"
 ...
 className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-md bg-green-50 text-green-700 hover:bg-green-100 transition-colors"
 ...
 className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-md bg-purple-50 text-purple-700 hover:bg-purple-100 transition-colors"
