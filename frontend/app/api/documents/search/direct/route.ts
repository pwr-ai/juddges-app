...
const routeLogger = logger.child('search/direct');
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const response = await fetch(`${backendUrl}/documents/search/direct`, {
      method: 'POST',
      headers,
    ...
    routeLogger.error('Error in search/direct proxy', error);
