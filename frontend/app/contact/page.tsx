    ...
    <PageContainer width="standard" className="py-12">
      ...
      <div className="mb-16 text-center">
        ...
        <Header
          title="Contact Us"
          size="4xl"
          description="Have questions about Legal AI? We're here to help. Reach out to our team for support, collaboration opportunities, or research inquiries."
      ...
      <LightCard padding="lg" className="mt-16 bg-muted/30">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Legal AI is primarily a research platform. For commercial inquiries or licensing,
