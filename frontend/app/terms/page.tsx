...
export const metadata = {
  title: "Terms of Service | Legal AI",
  description: "Terms of service for Legal AI legal research platform",
};
    ...
    <div className="container mx-auto px-6 py-12 md:px-8 lg:px-12 max-w-4xl">
      ...
      <LightCard padding="lg" className="mb-8">
        <p className="text-base leading-relaxed text-muted-foreground">
          These Terms of Service (&quot;Terms&quot;) govern your access to and use of the Legal AI platform operated by
      ...
      <LightCard 
        padding="lg" 
        className="mb-8 border-2 border-amber-500 bg-amber-500/20 dark:bg-amber-500/15 ring-2 ring-amber-500/20 shadow-lg [&>div:first-child]:bg-gradient-to-br [&>div:first-child]:from-amber-500/15 [&>div:first-child]:via-amber-400/8 [&>div:first-child]:via-transparent [&>div:first-child]:to-amber-500/10 dark:[&>div:first-child]:from-amber-500/20 dark:[&>div:first-child]:via-amber-400/10 dark:[&>div:first-child]:via-transparent dark:[&>div:first-child]:to-amber-500/15"
      >
        <div className="flex items-start gap-3 relative z-10">
          <AlertTriangle className="size-6 text-amber-600 dark:text-amber-500 mt-0.5 flex-shrink-0" />
          <div className="space-y-2">
            <h3 className="font-semibold text-amber-900 dark:text-amber-100">Important Legal Notice</h3>
            <p className="text-sm text-amber-800 dark:text-amber-200">
              Legal AI is a research platform providing AI-powered legal information for educational and research
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              By creating an account or using the Legal AI platform, you acknowledge that you have read,
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <div>
              ...
              <p>
                Legal AI is an academic research platform designed to support legal research and education through
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <div>
              ...
              <p>
                All content, features, and functionality of the Legal AI platform, including but not limited to
      ...
      <LightCard padding="lg" className="mt-8">
        ...
        <p className="text-base leading-relaxed text-muted-foreground">
          By using the Legal AI platform, you acknowledge that you have read these Terms of Service and agree to be
