...
const CHANGE_TYPE_LABELS: Record<string, { label: string; color: string }> = {
 initial: { label: 'Initial', color: 'bg-blue-100 text-blue-700 border-blue-200' },
 amendment: { label: 'Amendment', color: 'bg-amber-100 text-amber-700 border-amber-200' },
 correction: { label: 'Correction', color: 'bg-green-100 text-green-700 border-green-200' },
 consolidation: { label: 'Consolidation', color: 'bg-purple-100 text-purple-700 border-purple-200' },
 repeal: { label: 'Repeal', color: 'bg-red-100 text-red-700 border-red-200' },
};
...
export function VersionHistory({ documentId, onRevert }: VersionHistoryProps): React.JSX.Element {
 ...
 <pre className="diff-view p-4 text-xs font-mono overflow-x-auto max-h-[400px] overflow-y-auto whitespace-pre-wrap break-words bg-slate-50">
