...
async def get_documents_by_id(
    ...
    raise NotImplementedError(
        "This function has been removed. Use app.utils.judgment_fetcher.get_documents_by_id instead."
    )
...
async def get_documents_by_uuid(
    ...
    raise NotImplementedError(
        ...
        "Use app.utils.judgment_fetcher.get_documents_by_id with document IDs instead."
    )
