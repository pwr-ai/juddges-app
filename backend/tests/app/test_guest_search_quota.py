"""Unit tests for the anonymous-search quota (issue #510).
...
These tests pin the two properties that matter — the limit is enforced when
Redis is reachable, and search stays up when it is not.
"""
...
class _FakeSearchService:
    ...
    async def documents_search(self, **_: object) -> dict[str, object]:
        self.calls += 1
        return {
