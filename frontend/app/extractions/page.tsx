...
// Status badge colors
const STATUS_COLORS = {
  completed: "bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-300 border-green-200 dark:border-green-500/30",
  processing: "bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-500/30",
  failed: "bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-300 border-red-200 dark:border-red-500/30",
  pending: "bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-300 border-yellow-200 dark:border-yellow-500/30",
};
              ...
              <div className="flex items-center gap-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <button
                      type="button"
                      className="inline-flex items-center justify-center rounded-full w-5 h-5 text-muted-foreground hover:text-foreground hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                  ...
                  <PopoverContent
                    className="w-80 p-5 backdrop-blur-2xl bg-gradient-to-br from-white/20 via-white/15 to-white/10 dark:from-slate-900/20 dark:via-slate-900/15 dark:to-slate-900/10 border border-slate-200/20 dark:border-slate-700/20 shadow-2xl shadow-slate-200/20 dark:shadow-slate-900/40 ring-1 ring-white/5 dark:ring-slate-700/10"
                    align="start"
                  >
