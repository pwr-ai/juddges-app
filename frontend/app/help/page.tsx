              ...
              <Accordion type="multiple" className="space-y-3">
                {category.questions.map((question, idx) => (
                  <AccordionItem
                    ...
                    className="border rounded-xl bg-gradient-to-br from-blue-50/60 via-indigo-50/30 to-purple-50/20 dark:from-blue-950/30 dark:via-indigo-950/20 dark:to-purple-950/20 backdrop-blur-sm border-blue-200/50 dark:border-blue-800/50 shadow-sm px-6 py-2 transition-all duration-300"
                  >
