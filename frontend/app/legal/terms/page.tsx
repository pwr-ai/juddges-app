...
export const metadata: Metadata = {
  title: "Terms of Service | AI Tax Assistant",
  description: "Terms of service for AI Tax Assistant legal research platform",
};
  ...
  return (
    <div className="container mx-auto px-6 py-12 md:px-8 lg:px-12 max-w-4xl">
      ...
      <Card className="p-6 mb-8 bg-muted/30">
        <p className="text-sm">
          These Terms of Service (&quot;Terms&quot;) govern your access to and use of the AI Tax Assistant platform operated by
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              AI Tax Assistant is a research platform providing AI-powered legal information for educational and research
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              By creating an account or using the AI Tax Assistant platform, you acknowledge that you have read,
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <div>
              ...
              <p>
                AI Tax Assistant is an academic research platform designed to support legal research and education through
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <div>
              ...
              <p>
                All content, features, and functionality of the AI Tax Assistant platform, including but not limited to
      ...
      <Card className="mt-8 p-6 bg-muted/30 border-border/50">
        ...
        <p className="text-sm text-muted-foreground">
          By using the AI Tax Assistant platform, you acknowledge that you have read these Terms of Service and agree to be
