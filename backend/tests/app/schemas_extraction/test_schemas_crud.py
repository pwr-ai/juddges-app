...
class TestSchemaCreation:
    ...
    async def test_create_minimal_schema(
        ...
        client: AsyncClient,
        auth_headers: dict,
        minimal_schema_data: dict
    ):
        """Test creating a minimal valid schema."""
        response = await client.post(
            "/api/schemas",
            json=minimal_schema_data,
            headers=auth_headers
        )
    ...
    async def test_create_schema_missing_required_fields(
        ...
        response = await client.post(
            "/api/schemas",
            json=schema_with_missing_required,
            headers=auth_headers
        )
...
class TestSchemaRetrieval:
    ...
    async def test_get_converted_schema(
        ...
        # Get converted
        response = await client.get(
            f"/api/schemas/db/{schema_id}/convert",
            headers=auth_headers
        )
...
class TestSchemaListing:
    ...
    @pytest.mark.anyio
    async def test_list_schemas_from_db(
        self,
        client: AsyncClient,
        auth_headers: dict
    ):
    ...
    @pytest.mark.anyio
    async def test_list_schemas_without_auth(
        self,
        client: AsyncClient
    ):
