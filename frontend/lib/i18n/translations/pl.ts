...
export const pl: Translations = {
  ...
  navigation: {
    ...
    reasoningLines: 'Linie orzecznicze',
  ...
  compare: {
    pageTitle: 'Porównaj PL / UK',
    pageSubtitle: 'Jedno pytanie badawcze, ten sam ustrukturyzowany filtr uruchomiony dla orzeczeń polskich i brytyjskich, pola zakodowane obok siebie.',
    emptyTitle: 'Zadaj pytanie badawcze',
    emptyBody: 'Opisz sprawy zwykłym językiem lub wybierz filtry. Jurysdykcja jest tu zawsze rozdzielona — pomiń ją.',
    askQuestion: 'Opisz sprawy',
    matching: 'Pasujące orzeczenia',
    matchingPl: 'Polska',
    matchingUk: 'Wielka Brytania',
    shareAxis: '% zakodowanych dokumentów',
    coverageBadge: 'pokrycie PL {{pl}} % / UK {{uk}} %',
    sectionPrimary: 'Pola porównywalne',
    sectionPartial: 'Częściowe pokrycie — czytaj z ostrożnością',
    sectionUnavailable: 'Niedostępne dla jednej jurysdykcji',
    unavailableOne: 'Pole {{field}} nie jest wypełnione dla orzeczeń {{jurisdiction}} w tym wyniku ({{covered}} z {{total}}).',
    unavailableBoth: 'Pole {{field}} nie jest wypełnione dla żadnego pasującego dokumentu.',
    noMatchesTitle: 'Nic nie pasuje',
    noMatchesBody: 'Żadne ukończone orzeczenie nie pasuje do tego filtra w żadnej jurysdykcji. Złagodź warunek filtra.',
    jurisdictionIgnored: 'Warunek jurysdykcji został zignorowany — ta strona zawsze pokazuje PL i UK.',
    filterKeysIgnored: 'Niektóre klucze filtra zostały zignorowane:',
    savePair: 'Zapisz jako parę kolekcji',
    savePairTitle: 'Zapisz oba zestawy wyników',
    savePairName: 'Nazwa',
    savePairHint: 'Utworzy „{{name}} — PL” i „{{name}} — UK”.',
    savePairTooLarge: 'Jedna ze stron przekracza limit dla kolekcji. Najpierw zawęź filtr.',
    savePairSaving: 'Zapisywanie…',
    savePairGenericError: 'Nie udało się zapisać pary.',
    baseSchemaEyebrow: 'Schemat podstawowy',
    extendedSchemaEyebrow: 'Schemat rozszerzony',
    saved: 'Para zapisana',
    openCollections: 'Otwórz kolekcje',
    exportCsv: 'Eksportuj CSV',
    copyLink: 'Kopiuj link',
    linkCopied: 'Link skopiowany',
    pairEyebrow: 'Zapisana para',
    pairSchemaSection: 'Rozszerzone pola schematu',
    pairNoSchema: 'Uruchom ten sam schemat ekstrakcji na obu kolekcjach, aby porównać tu jego pola.',
    pairSchemaEmpty: 'Ten schemat nie ma pól, które można tu porównać na wykresie.',
    pairExtensionNoJobPl: 'Kolekcja UK ma zadanie ekstrakcji, ale kolekcja PL jeszcze nie.',
    pairExtensionNoJobUk: 'Kolekcja PL ma zadanie ekstrakcji, ale kolekcja UK jeszcze nie.',
    pairExtensionSchemaMismatch: 'Obie kolekcje zostały poddane ekstrakcji z różnymi schematami — uruchom ten sam na obu, aby porównać.',
    pairExtensionSchemaNotFound: 'Schemat ekstrakcji użyty dla tej pary już nie istnieje.',
    pairExtensionFailed: 'Nie udało się wczytać porównania rozszerzonego schematu. Pola podstawowe powyżej nie są tym dotknięte.',
    pairNotFound: 'Nie znaleziono tej pary. Mogła zostać usunięta albo nie masz do niej dostępu.',
