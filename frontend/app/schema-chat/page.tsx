              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <Popover open={schemaLoad.showSchemaPopover} onOpenChange={schemaLoad.setShowSchemaPopover}>
                    <PopoverTrigger asChild>
                      <button
                        ...
                        className={cn(
                          ...
                          "bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-slate-200/50 dark:border-slate-800/50",
                          "hover:bg-white/80 dark:hover:bg-slate-800/80 hover:scale-105 hover:shadow-md",
                    ...
                    <PopoverContent
                      className={cn(
                        "w-80 p-4 z-[100] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl backdrop-saturate-[180%]",
                                  ...
                                  {schemaLoad.savedSchemas
                                    ...
                                    .map((schema) => (
                                      <button
                                        ...
                                        className={cn(
                                          "w-full text-left px-3 py-2 rounded-md text-sm transition-colors hover:bg-primary/10 dark:hover:bg-primary/20 border border-transparent hover:border-primary/30",
                                          schemaLoad.selectedSchemaId === schema.id && "bg-primary/10 dark:bg-primary/20 border-primary/30"
                                        )}
                                      >
                                        <div className="flex items-center gap-2">
