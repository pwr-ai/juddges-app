...
schema_gen_pkg_dir = (
    Path(__file__).parent.parent.parent.parent / "packages" / "schema_generator_agent"
)
sys.path.insert(0, str(schema_gen_pkg_dir))

# Add juddges_search package for dependencies
juddges_search_pkg_dir = (
    Path(__file__).parent.parent.parent.parent / "packages" / "juddges_search"
)
