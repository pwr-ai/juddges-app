  ...
  return (
    <footer
      ...
      className={cn(
        ...
        "dark:from-slate-950/50 dark:via-slate-900/20 dark:to-slate-950/50",
        className
      )}
    >
      {/* Main Footer Content */}
      <div className="container mx-auto max-w-7xl px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <Badge 
            ...
            className={cn(
              ...
              "dark:from-blue-950/50 dark:via-indigo-950/40 dark:to-purple-950/50",
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 max-w-2xl leading-relaxed">
            AI-Tax is a research platform developed by Wrocław University of Science and Technology,
            providing AI-powered legal document analysis and research tools for court judgments and tax law.
          </p>
        </div>
        ...
        {/* Trust Badges */}
        <div className="mt-4 pt-3 border-t border-slate-200/30 dark:border-slate-900/5">
        ...
        <div className="mt-3 pt-3 border-t border-slate-200/30 dark:border-slate-900/5">
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed max-w-4xl">
            <strong className="font-semibold text-slate-700 dark:text-slate-300">Legal Notice:</strong> AI-Tax provides AI-powered legal information for
      ...
      {/* Bottom Bar */}
      <div className="container mx-auto max-w-7xl px-6 lg:px-8 py-3 border-t border-slate-200/30 dark:border-slate-900/5">
