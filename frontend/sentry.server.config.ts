/**
 * Sentry server-side initialization for Next.js 15 App Router.
 *
 * This runs in the Node.js server environment (API routes, server components,
 * server actions). No-op when SENTRY_DSN is not set.
 *
